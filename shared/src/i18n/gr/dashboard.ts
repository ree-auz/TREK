...
'dashboard.currency': 'Συνάλλαγμα',
  'dashboard.geoProvider': 'Map data provider',
  'dashboard.geoProviderGlobal': 'Global (OSM / Google)',
  'dashboard.geoProviderAmap': 'Mainland China (Amap)',
  'dashboard.geoProviderHint': 'Controls place search, routing, and map data for this trip.',
