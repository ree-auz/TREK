...
const dashboard: TranslationStrings = {
  ...
  'dashboard.geoProvider': '地圖資料提供方',
  'dashboard.geoProviderGlobal': '全球（OSM / Google）',
  'dashboard.geoProviderAmap': '中國大陸（高德地圖）',
  'dashboard.geoProviderHint': '控制此行程的地點搜尋、路線規劃和地圖資料。',
